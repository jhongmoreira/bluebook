<?php
  ...
  $vagaId = $_GET['vaga'];
  $banco->query("SELECT * FROM  escolaridade, vagas, empresas, categorias WHERE cod_empresa = id_empresa AND id_categoria = categoria_empresa AND cod_escolaridade = id_escolaridade AND id_vaga = $vagaId ORDER BY id_vaga LIMIT 1 ");
  $total = $banco->linhas();
  if ($total == 0){
    ...
    <div class="main-body">
          ...
          <nav aria-label="breadcrumb" class="main-breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page"><?php echo $dados['nome_vaga'];?></li>
            </ol>
          </nav>
          <!-- /Breadcrumb -->
              ...
              <div class="row gutters-sm">
                <div class="col-sm-12 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2"> <?php echo $dados['nome_vaga'];?></i>
                    </h6>
                        <?php 
